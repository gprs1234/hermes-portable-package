...
#    Arguments: -ExecutionPolicy Bypass -WindowStyle Hidden -File "<USER_HOME>\.hermes\scripts\windows_ea_heartbeat.ps1"
...
#   $action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-ExecutionPolicy Bypass -WindowStyle Hidden -File `"<USER_HOME>\.hermes\scripts\windows_ea_heartbeat.ps1`""
...
$heartbeatPath = "<USER_HOME>\AppData\Roaming\MetaQuotes\Terminal\CFDC9320EF2C819B475E6276F04DD44D\MQL4\Files\ea_heartbeat.json"

$heartbeat = @{
    timestamp = (Get-Date -Format "o")
    mt4_running = (Get-Process -Name "terminal64" -ErrorAction SilentlyContinue) -ne $null
    ea_files_dir = (Test-Path "<USER_HOME>\AppData\Roaming\MetaQuotes\Terminal\CFDC9320EF2C819B475E6276F04DD44D\MQL4\Files")
    latest_csv = $null
    csv_age_seconds = $null
}

# Check latest CSV
$csvDir = "<USER_HOME>\AppData\Roaming\MetaQuotes\Terminal\CFDC9320EF2C819B475E6276F04DD44D\MQL4\Files"
